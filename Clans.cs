...
{
    [Info("Clans", "Karstag", "1.0.8")]
    [Description("КланМеню(переписка фури)")]
    class Clans : RustPlugin
    {
        ...
        public void LoadDefaultMessages()
        {
            ...
            , this, "en");
			lang.RegisterMessages(new Dictionary<string, string> {
                {"nopermtocreate", "Ты не имеешь права создавать команду."},
                {"nopermtojoin", "Ты не имеешь права вступать в команду."}
                ,{"nopermtojoinbyinvite", "Игрок {0} не имеет права вступать в команду."}
                ,{"claninvite", "Вас пригласили вступить в команду: [{0}] '{1}'\nДля вступления введите: <color={2}>/clan join {0}</color>"}
                ,{"comeonline", "{0} зашёл в онлайн!"}
                ,{"goneoffline", "{0} ушел в офлайн!"}
                ,{"friendlyfire", "{0} является членом команды и не может быть поранен вами.\nЧтобы переключить режимы дружественного огня команды введите: <color={1}>/clan ff</color>"}
                ,{"allyfriendlyfire", "{0} является членом союзника и не может быть ранен."}
                ,{"notmember", "В настоящее время вы не являетесь членом команды."}
                ,{"youareownerof", "Вы являетесь владельцем:"}
                ,{"youaremodof", "Вы являетесь модератором:"}
                ,{"youarecouncilof", "Ты состоишь в:"}
                ,{"youarememberof", "Вы состоите в команде:"}
                ,{"claninfo", " [{0}] {1}"}
                ,{"memberon", "Участники онлайн: "}
                ,{"overviewnamecolor", "<color={0}>{1}</color>"}
                ,{"memberoff", "Участники в офлайн: "}
                ,{"notmoderator", "Вы должны быть модератором своего команды, чтобы использовать эту команду."}
                ,{"pendinvites", "Ожидающие приглашения: "}
                ,{"bannedwords", "Тег команды содержит запрещенные слова."}
                ...
                ,{"hintlength", "Теги команды должны быть длиной от {0} до {1} символов"}
                ,{"hintchars", "Командные теги должны содержать только 'a-z' 'A-Z' '0-9' '{0}'"}
                ,{"providedesc", "Пожалуйста, дайте краткое описание вашей команды."}
                ,{"tagblocked", "Уже есть команда с этим тегом."}
                ,{"nownewowner", "Вы являетесь владельцем команды [{0}] \"{1}\""}
                ...
                ,{"alreadymember", "Этот игрок уже является членом вашего команды: {0}"}
                ,{"alreadyinvited", "Этот игрок уже приглашен в вашу команду: {0}"}
                ,{"alreadyinclan", "Этот игрок уже состоит в команде: {0}"}
                ,{"invitebroadcast", "{0} приглашен {1} в команду."}
                ,{"usagewithdraw", "Использование: <color={0}>/clan withdraw <name></color>"}
                ,{"notinvited", "Этот игрок не был приглашен в ваш команду: {0}"}
                ,{"canceledinvite", "{0} отменил приглашение {1}."}
                ,{"usagejoin", "Использование: <color={0}>/clan join \"Название\"</color>"}
                ,{"youalreadymember", "Ты уже состоишь в команде."}
                ,{"younotinvited", "Вас не приглашали присоединиться к этой команде."}
                ,{"reachedmaximum", "Эта команда уже достигла максимального количества членов."}
                ,{"broadcastformat", "<color={0}>{1}</color>: {2}"}
                ,{"allybroadcastformat", "[{0}] <color={1}>{2}</color>: {3}"}
                ,{"clanrenamed", "{0} переименовал свою команду в: [{1}]."}
                ,{"yourenamed", "Вы переименовали команду с [{0}] в [{1}]"}
                ,{"clandeleted", "{0} удалил свою команду."}
                ,{"youdeleted", "Вы удалили  команду[{0}]"}
                ,{"noclanfound", "Нет команды с такой меткой [{0}]"}
                ,{"renamerightsowner", "Вы должны быть владельцем сервера, чтобы переименовать команды."}
                ,{"usagerename", "Использование: <color={0}>/clan rename OLDTAG NEWTAG</color>"}
                ,{"deleterightsowner", "Вы должны быть владельцем сервера, чтобы удалить команду."}
                ,{"usagedelete", "Использование: <color={0}>/clan delete Название</color>"}
                ,{"clandisbanded", "Ваш нынешний команда был распущен навсегда."}
                ,{"needclanowner", "Вы должны быть владельцем своей команды, чтобы использовать эту команду."}
                ...
                ,{"playerjoined", "{0} присоединился к команде!"}
                ,{"waskicked", "{0} выгнали {1} из команды."}
                ,{"modownercannotkicked", "Игрок {0} является владельцем или модератором и не может быть выгнан."}
                ,{"notmembercannotkicked", "Игрок {0} не является членом вашего команды."}
                ...
                ,{"playerleft", "{0} покинул команжу."}
                ,{"youleft", "Вы покинули команду."}
                ,{"usageleave", "Использование: <color={0}>/clan leave</color>"}
                ,{"notaclanmember", "Игрок {0} не является членом вашей команды."}
                ,{"alreadyowner", "Игрок {0} уже является владельцем вашей команды."}
                ,{"alreadyamod", "Игрок {0} уже является модератором вашей команды."}
                ,{"alreadyacouncil", "Игрок {0} уже является членом совета вашей команды."}
                ,{"alreadyacouncilset", "Должность председателя совета уже присуждена."}
                ,{"maximummods", "Эта команда уже достиг максимального количества модераторов."}
                ...
                ,{"notamoderator", "Игрок {0} не является модератором вашей команды."}
                ,{"notpromoted", "Игрок {0} не является модератором или советом вашей команды."}
                ,{"playerdemoted", "{0} понижен в должности {1} до члена."}
                ,{"councildemoted", "{0} понижен в должности {1} до модератора."}
                ,{"noactiveally", "У вашей команды нет нынешних альянсов."}
                ,{"yourffstatus", "Огонь по своим:"}
                ,{"yourclanallies", "Ваши союзники по командам:"}
                ,{"allyinvites", "Приглашения в союз:"}
                ,{"allypending", "Запросы союзников:"}
                ,{"allyReqHelp", "Предложите союз другой команде"}
                ,{"allyAccHelp", "Принимаем в альянс с другими командами"}
                ,{"allyDecHelp", "Отказаться от союза с другими командами"}
                ,{"allyCanHelp", "Отменить союз с другой командой"}
                , {
                    "reqAlliance", "[{0}] запросил командный союз"
                }
                , {
                    "invitePending", "У вас уже есть ожидающее приглашение на альянс [{0}]"
                }
                , {
                    "clanNoExist", "команды [{0}] не существует"
                }
                , {
                    "alreadyAllies", "Вы уже вступили в союз с"
                }
                , {
                    "allyProvideName", "Вам нужно указать название команды"
                }
                , {
                ...
                , {
                    "allyCancelSucc", "{0} отменил ваш командный союз"
                }
                , {
                    "noAlly", "Ваши команлы не имеют союза друг с другом"
                }
                , {
                ...
                , {
                    "allyDeclined", "Вы отказались от командного союза с [{0}]"
                }
                , {
                    "allyDeclinedSucc", "[{0}] отклонил ваш запрос на союз"
                }
                , {
                    "allyReq", "Вы запросили командный союз у [{0}]"
                }
                , {
                    "allyAcc", "Вы приняли командный союз от [{0}]"
                }
                , {
                    "allyAccSucc", "[{0}] принял ваш запрос на союз"
                }
                , {
                    "allyPendingInfo", "У вашего команды есть ожидающий запрос(ы) союзника (ов). Проверьте их в обзоре команд."
                }
                , {
                    "clanffdisabled", "У тебя есть <color={0}>disabled</color> дружественный огонь для вашей команды.\nВы в безопасности!"
                }
                , {
                    "clanffenabled", "У тебя есть <color={0}>enabled</color> дружественный огонь для вашей команды.\nБудь осторожен!"
                }
                , {
                    "yourname", "ВЫ"
                }
                ...
                , {
                    "helpinformation", "Отображение информации о вашей команде"
                }
                , {
                ...
                , {
                    "helpcreate", "Создайте новую команду"
                }
                , {
                    "helpjoin", "Вступайте в команду по приглашению"
                }
                , {
                    "helpleave", "Оставь свою команду"
                }
                , {
                ...
                , {
                    "helpdisband", "Расформируйте свою команду (без отмены)"
                }
                , {
                ...
                , {
                    "yourradarstatus", "Твой КомандныйРадар:"
                }
                , {
                    "clanradardisabled", "Командный радар отключен"
                }
                , {
                    "clanradarenabled", "Командный радар включен"
                }
                , {
                    "helptoggleradar", "Переключение статуса радара команды"
                }
                , {
                    "clanArgCreate", "create"
                }
        ...
        void OnServerInitialized()
        {
            ...
            else
            {
                ...
                ImageLibrary?.Call("AddImage", "https://i.imgur.com/pz8fJKp.png", "loot-barrel");
            }
            LoadData();
            if (enableClanRadar)
            {
      ...
      int thirdplace = 50;
        ...
        void cmdSetChangeOfClan(ConsoleSystem.Arg args)
        {
            ...
            for (int i = 0; i < clan.Change.Count; i++)
            {
                ...
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.36 0.36 0.36 0.8", Command = $"" },
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.36 0.36 0.36 0.8", Command = $"clanui.page 0" },
                Text = { Text = "УСТАНОВИТЬ", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-bold.ttf", Color = "1 0.9294118 0.8666667 1" },
        ...
        [PluginReference]
        public Plugin ItemNameLocalizator;
        ...
        double GetPercentNow(double need, double current) {
			if (need==0) return 0;
			return current;
		}
        ...
        void ClanTOPInfo(BasePlayer player, Clan clan, int page)
        {
            ...
            CuiHelper.AddUi(player, InfoTOP.Replace("{clanname}", "КОМАНДА: " + clan.tag.ToUpper() + " | ")
        ...
        {			
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(10 * page).Take(ClanMembers.ToList().Count >= 10 ? 10 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.025 0.1", AnchorMax = $"0.1355833 1" },
                }, "clans_player" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.16 0", AnchorMax = $"0.6 1" },
                }, "clans_player" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.62 0", AnchorMax = $"0.8270121 1" },
                }, "clans_player" + key.Key);

                 elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.members.Count}".ToUpper(), Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.75 0", AnchorMax = $"0.9985565 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiButton
                {
                ...
                elements.Add(new CuiButton
            {
                ...
                Button = { Color = "0.1 0.6 0.160 1", Command = $"clanstop_info {myClan.tag}"},
                Text = { Text = "МОЯ КОМАНДА", Align = TextAnchor.MiddleCenter},
                RectTransform = { AnchorMin = $"0.43 0.305", AnchorMax = $"0.55 0.36" },
            }, "Clanstop_main2", "clans_page");
            
            elements.Add(new CuiButton
            {
                
                Button = { Color = "0.50 0.47 0.40 0.7", Close = "Clanstop_main2"  },
                Text = { Text = "ЗАКРЫТЬ", Align = TextAnchor.MiddleCenter},
                RectTransform = { AnchorMin = $"0.63 0.305", AnchorMax = $"0.748 0.36" },
            }, "Clanstop_main2", "clans_page");
                i++;
                Amin = Amin - 0.073;
                Amax = Amax - 0.073;
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.25 0.25 0.23 0.9"},
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.001 0.001", AnchorMax = $"0.2 0.1" },
            }, "Clanstop_main8", "clans_page");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.5 0.47 0.40 1", Command = page > 0 ? $"clanstop_main {page - 1}" : "" },
                Text = { Text = "-", Color = "1 0.9294118 0.8666667 1", FontSize = 25, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.33 0.997" },
            }, "clans_page");
            ...
            elements.Add(new CuiButton
            {
                ...
                Text = { Text = $"{page + 1}", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-bold.ttf", FontSize = 25, Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.33 0", AnchorMax = $"0.66 0.997" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.5 0.47 0.40 1", Command = clans.Keys.Skip(10 * (page + 1)).Count() > 0 ? $"clanstop_main {page + 1}" : "" },
                Text = { Text = "+", Color = "1 0.9294118 0.8666667 1", FontSize = 25, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.66 0", AnchorMax = $"0.997 0.997" },
            }, "clans_page");
            CuiHelper.AddUi(player, elements);
        ...
        void ClanUI(BasePlayer player, int page = 0, bool changeSkin = false, bool changeResource = false)
        {
            ...
            string Main = "[{\"name\":\"clans_main1\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"material\":\"assets/content/ui/uibackgroundblur-ingamemenu.mat\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main15\",\"parent\":\"clans_main1\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1711 0.679999\",\"anchormax\":\"0.595 0.99\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main16\",\"parent\":\"clans_main15\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.2994118 0.2994118 0.2994118 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0.15\",\"anchormax\":\"0.35 0.9\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main2\",\"parent\":\"clans_main1\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.17 0.1546297\",\"anchormax\":\"0.83 0.8935185\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main3\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.3294118 0.3294118 0.3294118 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.943609\",\"anchormax\":\"0.9953553 0.9955974\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main4\",\"parent\":\"clans_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b></b>\",\"fontSize\":18,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main5\",\"parent\":\"clans_main4\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"clans_main1\",\"color\":\"0.5254902 0.282353 0.2313726 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.935175 0\",\"anchormax\":\"1.5211111 5.94\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main6\",\"parent\":\"clans_main5\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>X</b>\",\"fontSize\":33,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"2 1\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main10\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.3294118 0.3294118 0.3294118 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.6918138\",\"anchormax\":\"0.6431664 0.9398496\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanLogo\",\"parent\":\"clans_main1\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.3294118 0.3294118 0.3294118 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.05315594 0.02741549\",\"anchormax\":\"0.2838709 0.9721818\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanInfo\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.2745098 0.2745098 0.5745098 0.1948693\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3418818 -0.13\",\"anchormax\":\"0.9822304 0.9788673\",\"offsetmin\":\"-185 15\",\"offsetmax\":\"10 3.9\"}]},{\"name\":\"ClanName\",\"parent\":\"clans_main15\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0.55\",\"anchormax\":\"0.9 0.72\",\"offsetmin\":\"1 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName1\",\"parent\":\"ClanName\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗВАНИЕ КОМАНДЫ: \",\"fontSize\":16,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.021675 0\",\"anchormax\":\"5.956291 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>{Title}</b>\",\"fontSize\":14,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName2\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 1.3\",\"anchormax\":\"0.9 1.584863\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"ClanName2\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ГЛАВА КОМАНДЫ:\",\"fontSize\":16,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.4698553 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName2\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{LeaderName}\",\"fontSize\":14,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0.68\",\"anchormax\":\"0.9 0.98\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName4\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"УЧАСТНИКОВ В ИГРЕ:\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8705882 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.5718051 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{O/P}\",\"fontSize\":16,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0.38\",\"anchormax\":\"0.9 0.67\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName4\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"МЕСТО В ТОПЕ:\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8705882 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.6493754 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{per}\",\"fontSize\":16,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main11\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6467149 0.7078139\",\"anchormax\":\"0.9980168 1.13\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main101\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.2994118 0.2994118 0.2994118 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.7 0.75\",\"anchormax\":\"0.94 1.05\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main112\",\"parent\":\"clans_main11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ТЕКУЩАЯ ЗАДАЧА</b>\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.7554934\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main113\",\"parent\":\"clans_main11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b></b>\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.02572244\",\"anchormax\":\"1 0.7554934\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main9\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548518 0.4335839\",\"anchormax\":\"0.9971297 0.6859453\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main91\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>НАБОР КОМАНДНОЙ ОДЕЖДЫ</b>\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.8\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_item0\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Background\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.06081926 0.04293609\",\"anchormax\":\"0.1799577 0.7877806\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item1\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Background\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1871024 0.04293609\",\"anchormax\":\"0.3062414 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item2\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.useGUILayout\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3133879 0.04293609\",\"anchormax\":\"0.4325227 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item3\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.useGUILayout\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4396606 0.04293609\",\"anchormax\":\"0.558799 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item4\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.useGUILayout\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5659431 0.04293609\",\"anchormax\":\"0.6850816 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item5\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Background\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6922278 0.04293609\",\"anchormax\":\"0.8113656 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item6\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Background\",\"color\":\"0 0 0 0.1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.81852 0.04293605\",\"anchormax\":\"0.9376571 0.7877805\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main7\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0020 -0.2\",\"anchormax\":\"0.6431664 0.4285714\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main71\",\"parent\":\"clans_main7\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.911024\",\"anchormax\":\"1 0.9998377\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main722\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"#\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.0366677 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main723\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НИК ИГРОКА\",\"fontSize\":13,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.06366677 0\",\"anchormax\":\"0.4043106 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main724\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"АКТИВНОСТЬ\",\"fontSize\":13,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4056678 0\",\"anchormax\":\"0.6526684 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main725\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НОРМА\",\"fontSize\":13,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6526684 0\",\"anchormax\":\"0.75 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main726\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ДЕЙСТВИЯ\",\"fontSize\":13,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.85 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main8\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.50 0.47 0.41 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6467149 -0.2\",\"anchormax\":\"0.9980168 0.4285714\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main81\",\"parent\":\"clans_main8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ДОБЫЧА РЕСУРСОВ</b>\",\"fontSize\":15,\"font\":\"robotocondensed-bold.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.8873403\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";
            var Messages = "";
            ...
            string colored = "0.25 0.25 0.23 0.8";
            var elements = new CuiElementContainer();
            double Amin = 0.8;
            double Amax = 0.9;
            ...
            foreach (var key in clan.members.OrderBy(pair => BasePlayer.FindByID(ulong.Parse(pair.Key)) == null).Skip(8 * page).Take(clan.members.Count >= 8 ? 8 : clan.members.Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = "●", Color = playerKey != null ? "0.00 1.00 0.00 1.00" : "1.00 0.00 0.00 1.00", FontSize = 12, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
            ...
            for (int i = 0; i < clan.Change.Count; i++)
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{GetPercentNow((int)clan.Change.ToList()[i].Value.Need, (int)clan.Change.ToList()[i].Value.Complete)}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = "0.6 -0.5", AnchorMax = "1 1" },
                }, $"clans_main88{clan.Change.ToList()[i].Key}");
            ...
            if (clan.owner == player.UserIDString)
            {
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = changeSkin ? $"clanui.page {page}" : $"clanui.page {page} true" },
                    Text = { Text = changeSkin ? "Save" : "Изменить", Color = "0 0 0 0", Font = "robotocondensed-bold.ttf", FontSize = 14, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 -4", AnchorMax = $"1 0.95" },
                }, "clans_main91");

                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = $"clan_setChange" },
                    Text = { Text = "", Color = "1 0.9294118 0.8666667 1", FontSize = 13, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.993 0.89" },
                }, "clans_main8");
            }
...
'\n'
        ...
        public class Clan
        {
          ...
          public  string barrelinfo = "loot-barrel";
